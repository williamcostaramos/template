            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="<?php bloginfo('template_url');?>/index.php"> <img src="<?php bloginfo('template_url')?>/img/logo.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php bloginfo('url')?>/contact.html">Contato</a>
                                </li>
                            </ul>
                        </div>
